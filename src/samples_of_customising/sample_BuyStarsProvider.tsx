...
// Глобальные кастомные стили с новой скобочной нотацией
const globalCustomStyles: CustomStyles = {
  ['Button']: {
  ...
  ['Drawer']: {
    ...
    root: 'bg-gradient-to-br from-indigo-800/30 to-pink-800/30 backdrop-blur-sm',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-white mb-8 text-center bg-gradient-to-r from-indigo-400 to-pink-400 bg-clip-text text-transparent">
          🎨 SafeStars Global Custom Styles Demo
        </h1>
        
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
          <h2 className="text-2xl font-semibold text-white mb-6 text-center">
            Global Custom Styles Applied via SafeStarsProvider
          </h2>
          ...
          <div className="text-gray-300 mb-6">
            ...
            <p className="mb-2">• ⚡ <strong>Spinner:</strong> Фиолетовые цвета</p>
            <p className="mb-4">• 🎯 Все стили применяются глобально через classes prop в SafeStarsProvider</p>
          </div>

          <div className="flex flex-col space-y-4 items-center">
            <BuyStarsButton stars={100}>
              🌟 Buy 100 Stars (Global Custom Style)
            </BuyStarsButton>
            
            <BuyStarsButton stars={500}>
              💫 Buy 500 Stars (Global Custom Style)
            </BuyStarsButton>
            
            <div className="text-sm text-gray-400 text-center mt-4">
              Нажмите на кнопки, чтобы увидеть как глобальные кастомные стили<br/>
        ...
        <div className="mt-8 bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-600/30">
...
{`const globalStyles: CustomStyles = {
  ...
  ['Drawer']: {
    overlay: 'bg-purple-900/80 backdrop-blur-lg',
    root: 'bg-purple-800/30',
    header: 'bg-purple-700',
    title: 'text-white font-bold',
    closeButton: 'bg-red-500 text-white',
    content: 'bg-purple-800/30'
  },
  ['Spinner']: {
...
<SafeStarsProvider classes={globalStyles}>
  <BuyStarsButton stars={100} />
</SafeStarsProvider>`}
          </pre>
        </div>
